...
import (
	...
	"suteqa/etcd/clientv3/credentials"
	"suteqa/etcd/etcdserver"
	"suteqa/etcd/etcdserver/api/v3client"
	"suteqa/etcd/etcdserver/api/v3election"
	"suteqa/etcd/etcdserver/api/v3election/v3electionpb"
	v3electiongw "suteqa/etcd/etcdserver/api/v3election/v3electionpb/gw"
	"suteqa/etcd/etcdserver/api/v3lock"
	"suteqa/etcd/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "suteqa/etcd/etcdserver/api/v3lock/v3lockpb/gw"
	"suteqa/etcd/etcdserver/api/v3rpc"
	etcdservergw "suteqa/etcd/etcdserver/etcdserverpb/gw"
