...
running(leaking) after all tests.
	...
	import "suteqa/etcd/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "suteqa/etcd/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "suteqa/etcd/pkg/logutil.(*MergeLogger).outputLoop") ||
